...
#SECOND################
#circles adding from inside to outside
   send_signal(pattern_circle1)
   time.sleep(0.45)
   send_signal(all_off)
   send_signal(circle_1n2)
   time.sleep(0.45)
   send_signal(all_off)
   send_signal(circle_1n2n3)
   time.sleep(0.45)
   send_signal(all_off)
   send_signal(circle_1n2n3n4)
   time.sleep(0.5)
   send_signal(all_off)
   send_signal(circle_1n2n3n4n5)
   time.sleep(0.5)
   send_signal(all_off)

#dots running outward on circles
   send_signal(adding_circles_going_out_stage1)
   time.sleep(0.03)
   send_signal(all_off)
   send_signal(adding_circles_going_out_stage2)
   ...
   time.sleep(0.03)
   send_signal(all_off)
   send_signal(adding_circles_going_out_stage16)
   time.sleep(0.03)
   send_signal(all_off)
   send_signal(adding_circles_going_out_stage17)
   time.sleep(0.03)
   ...
   time.sleep(0.03)
   send_signal(all_off)
   send_signal(adding_circles_going_out_stage20)
   time.sleep(0.01)
   send_signal(all_off)

   #dots running inward on circles
   send_signal(adding_circles_going_out_stage20)
   time.sleep(0.03)
   send_signal(all_off)
   send_signal(adding_circles_going_out_stage19)
...
#dots running outward on circles
   ...
   time.sleep(1.045)
   send_signal(all_off)
   send_signal(alternate_whole_sector_like_wings)
   time.sleep(1.045)
   send_signal(all_off)
   send_signal(circle_4_and_5)
   time.sleep(1.045)
   send_signal(all_off)
   send_signal(all_rays)
   time.sleep(1.045)
   send_signal(all_off)
...
#Tyawn tyawn music for the secons time
#FIRST##################
   send_signal(ray_pair_1)
   time.sleep(0.5)
   send_signal(all_off)
...
#rays moving from left to right
   send_signal(l1)
   time.sleep(0.05)
   send_signal(all_off)
   send_signal(l2)
   ...
   #rays moving from right to left
   send_signal(l9)
   time.sleep(0.05)
   send_signal(all_off)
   send_signal(l8)
